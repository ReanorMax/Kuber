...
> 📚 **[Полный индекс документации](docs/INDEX.md)** - удобная навигация по всем гайдам с описанием и связями
> 
> ⚡ **[Быстрые ссылки](QUICK-LINKS.md)** - самые нужные документы одним кликом
...
- **10+ специализированных гайдов** по конкретным темам
...
- [`docs/pods-vs-containers-explained.md`](docs/pods-vs-containers-explained.md) - **Pod vs Container**: в чем разница, multi-container паттерны
- [`docs/prometheus-stack-components.md`](docs/prometheus-stack-components.md) - **Prometheus Stack**: все 6 компонентов и их роли
- [`docs/port-forwarding-explained.md`](docs/port-forwarding-explained.md) - **Проброс портов**: 3 уровня (Docker, NodePort, Service)
- [`docs/port-mapping-diagram.md`](docs/port-mapping-diagram.md) - **Визуальная диаграмма** проброса портов

#### 🔐 Сеть и безопасность
- [`docs/ssh-tunnel-explained.md`](docs/ssh-tunnel-explained.md) - **SSH туннель**: как работает `-L 6443:127.0.0.1:41917`
- [`docs/kubernetes-distributions-comparison.md`](docs/kubernetes-distributions-comparison.md) - **Сравнение дистрибутивов**: Minikube vs Kind vs K3s

#### 🛠️ Практические инструкции
- [`docs/how-to-check-env-variables.md`](docs/how-to-check-env-variables.md) - **Переменные окружения**: как проверять через kubectl и Lens
- [`docs/kind-infrastructure-setup-guide.md`](docs/kind-infrastructure-setup-guide.md) - **Настройка Kind**: как был поднят кластер
- [`docs/gui-tools-comparison.md`](docs/gui-tools-comparison.md) - **GUI инструменты**: Lens vs Dashboard vs k9s
- [`docs/complete-user-guide.md`](docs/complete-user-guide.md) - **Полный гайд пользователя**: все в одном месте
